         ...
         <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
            <div className="text-sm sm:text-md font-normal sm:font-medium bg-white rounded-lg p-3 sm:p-10">
               ...
               <div className="space-y-6 text-gray-700 leading-relaxed">
                  <p>
                     This Seller Privacy Policy (&quot;Privacy Policy&quot;) describes how Temu (&quot;we&quot;, &quot;us&quot; or &quot;our&quot;) handles personal information that we collect from current and prospective sellers and their directors, officers, employees, agents, and/or representatives (each, a &quot;Seller&quot;, and collectively, the &quot;Sellers&quot;) through our digital properties that link to this Privacy Policy, including but not limited to our Seller Center websites, mobile application, and related services (collectively, the &quot;Service&quot;), and other activities as described in this Privacy Policy. At Temu, we care deeply about privacy. We strive to be transparent about our privacy practices, including how we treat your personal information. If you interact with Temu as a consumer, you should view the Temu <a href="https://www.temu.com/privacy-and-cookie-policy.html" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">Privacy Policy</a> for details regarding the processing of your personal information, as this Privacy Policy only applies to personal information about you as a Seller. By continuing to use our Service, you acknowledge the practices described in this Privacy Policy.
                  </p>
                  ...
                  <p>Different Temu entities handle your personal information based on the country/region where you choose to use the Service:</p>
                  ...
                  <ul className="list-disc list-inside space-y-3 ml-4">
                     ...
                     <li><strong>Public authorities, public sources, and other parties.</strong> We obtain your personal information from third party sources, such as government agencies, public records, other publicly available sources, customers of Temu or other third parties providing information about transactions or claims they may have related to you.</li>
                  ...
                  <p>We process your personal information that we collect for various purposes, including but not limited to, verifying your identity, to develop, improve, support, and provide the Service, allowing you to use its features and to fulfill and enforce our Temu Seller Services Agreement. We may use your personal information for the following purposes:</p>
                  ...
                  <p><strong>Fraud prevention and security.</strong> We use your personal information to prevent, detect, investigate, and respond to fraud, unauthorized access to or use of the Service, violations of the Temu Seller Services Agreement and/or other Temu policies, or other misconduct.</p>
                  ...
                  <p>At Temu, we care deeply about privacy. We may share your personal information with the following parties for the purposes outlined below:</p>

                  <p><strong>Affiliates.</strong> As a global company, our Service is supported by entities within our corporate group. We share some of your personal information with Temu subsidiaries and affiliates as necessary to provide organizational, technical, legal and compliance support for the Service, including for the purposes of providing and optimizing services, detecting irregular activities and safeguarding our Service and/or public safety. Such personal information includes name, address, corporate information, shop details and contact information. These subsidiaries and affiliates either follow the same practices described in this Privacy Policy or follow practices at least as protective as those described in this Privacy Policy.</p>
                  ...
                  <p><strong>Opt-out from marketing communications.</strong> To manage your preferences, opt out of or withdraw your consent to, marketing communications, you can take any of the following actions. Rest assured that you can continue to use Temu even if you opt out of marketing communications.</p>
                  ...
                  <p>Data of Sellers will be stored in the infrastructure of cloud service providers. As a global one-stop shopping destination, Temu may need to engage and share your personal information to various parties, including our service providers, as described in the &quot;<a href="#how_and_why_we_share_your_information" className="text-orange-500 hover:underline">How and Why We Share Your Information</a>&quot; section. These parties may be located in countries or jurisdictions that have data protection laws that are different in some aspects from the laws of the country or jurisdiction in which you reside. When we transfer your personal information outside the country or jurisdiction in which you reside, we implement appropriate measures to ensure that your personal information will remain protected in accordance with this Privacy Policy and applicable laws.</p>
                  ...
                  <p>For non-EEA/UK/Switzerland residents, please send an email to <a href="mailto:sellersupport@temu.com" className="text-orange-500 hover:underline">sellersupport@temu.com</a>.</p>
               </div>
