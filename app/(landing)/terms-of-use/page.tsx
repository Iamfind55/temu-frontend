   ...
   return (
      <div className="min-h-screen bg-white">
         ...
         <div className="max-w-7xl mx-auto px-4 pt-8 pb-4">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">Tamu | U.S. | Terms of Use</h1>
               ...
               <main className="flex-1 min-w-0">
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        ...
                        <ul className="list-disc list-inside ml-4 space-y-2">
                           <li>Our website and mobile apps, which may offer features, products, services or content, including exchanges of information, as &quot;Tamu&quot; or &quot;our app&quot;; and</li>
                           <li>End users, including visitors to Tamu and those who use Tamu to purchase products as &quot;you.&quot;</li>
                        </ul>
                        <p>
                           <strong>1.3</strong> We and our affiliates provide technical and operational support for our app. You may pay for multiple orders in one transaction on Tamu. Multiple orders may be delivered together in one package.
                        </p>
                        <p>
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        ...
                        <p>
                           <strong>8.5</strong> It is a material breach of these Terms to arrange for the sale of listed items from, or the payment of fees to third parties outside the context of Tamu for the purposes of circumventing the obligation to pay the fee for products purchased through the Services.
                        </p>
                     </div>
                  </section>
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        <p>
                           <strong>9.1</strong> We expressly disclaim any liability that may arise between users of Tamu. If there is a dispute between you and another user or any third party on Tamu, we are under no obligation to become involved. To the fullest extent permitted under applicable law, you release us, our parents, subsidiaries, affiliates, directors, officers, employees, agents and successors from all claims, demands, and damages of every kind or nature, known or unknown, suspected or unsuspected, disclosed or undisclosed, arising out of or in any way related to such disputes.
                        </p>
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        ...
                        <p>
                           <strong>10.2</strong> While we strive to provide accurate information on Tamu, typographical errors, inaccuracies, or omissions that relate to pricing, product descriptions, availability, and offers may occur. Subject to applicable law, we reserve the right to correct any errors, inaccuracies, or omissions and to change or modify information or cancel orders or parts of orders if any information on Tamu is inaccurate at any time without prior notice, including after your order has been submitted or your receipt of an order confirmation or shipping notice. You should not rely on the strike-through price in your purchase decision. If comparing prices is important to your purchase decision, you should do your own comparison before making a purchase.
                        </p>
                        <p>
                        ...
                        <p>
                           <strong>10.4</strong> We make reasonable efforts to ensure the color display of the products on Tamu is as accurate as possible. However, we cannot guarantee that your monitor&apos;s display of any color will be an accurate depiction of the color of the product you selected to purchase.
                        </p>
                        <p>
                           <strong>10.5</strong> You acknowledge that the products are in conformity with the transaction or intended purchase if they: (i) comply with the description provided on Tamu and possess the qualities presented on Tamu; (ii) are fit for the purposes for which goods of such kind are normally used; and (iii) are of the quality and performance which are normal in goods of the same type and which can reasonably be expected.
                        </p>
                        <p>
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        ...
                        <p>
                           <strong>11.2</strong> We want you to be satisfied with your purchases through the Services. For all the products purchased on Tamu, you may be entitled to a return and refund. For details of return and refund, please visit our <a href="/return-refund-policy" className="text-orange-500 hover:underline">Return and Refund Policy</a>. Please follow the instructions in the policy if you want to request a refund. You acknowledge and agree that we may issue a refund to you in accordance with the Return and Refund Policy.
                        </p>
                        <p>
                  ...
                  >
                     ...
                     <div className="text-sm text-gray-700 mt-4 space-y-4">
                        ...
                        <ul className="list-disc list-inside space-y-2">
                           <li>if you are using a Tamu website, please contact Tamu customer service via the &quot;Contact us&quot; page linked in the website footer; or</li>
                           <li>if you are using a Tamu application, please contact Tamu customer service via the &quot;Customer support&quot; section in the &quot;You&quot; menu at the bottom of the home page.</li>
                        </ul>
                        <p>
