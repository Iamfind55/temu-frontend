...
export default function ShopCreditPage() {
  ...
  const [withdrawCryptoType, setWithdrawCryptoType] = useState("ETH")
  ...
  const cryptoAddresses = {
    ETH: "0x64595371ef111e9991c10A9C92262d13FF7C4BbA",
    "TRX/USDT": "TUmVmsJGN58H5ntcvqrx5SdV8hUiRQMP5D",
      ...
      <div className="flex-1 bg-white p-2 sm:p-6">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-wrap items-center justify-start gap-4 sm:gap-8 mb-8 sm:mb-0">
            ...
            <div className="mb-2 sm:mb-8">
              <p className="mb-2 text-sm text-gray-600">{t('recharge')}</p>
              <p className="text-xl sm:text-xl font-bold text-green-600">
                {walletLoading ? "..." : `$${(wallet?.total_recharged || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
              </p>
            </div>

            <div className="mb-2 sm:mb-8">
              <p className="mb-2 text-sm text-gray-600">{t('withdraw')}</p>
              <p className="text-xl sm:text-xl font-bold text-red-600">
                {walletLoading ? "..." : `$${(wallet?.total_withdraw || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
              </p>
            </div>

            <div className="mb-2 sm:mb-8">
              <p className="mb-2 text-sm text-gray-600">{t('pending')}</p>
              <p className="text-xl sm:text-xl font-bold text-yellow-600">
            ...
            <div className="mb-2 sm:mb-8">
              ...
              <p className="text-xl sm:text-xl font-bold text-green-600">
                {walletLoading ? "..." : `$${(wallet?.total_withdraw_able_balance || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
              </p>
            </div>
          </div>
            ...
            <div className="rounded-lg border border-gray-200 p-4 space-y-3 bg-gray-50">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${Number(amount || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="rounded-lg border border-green-200 p-4 bg-green-50">
              ...
              <p className="text-2xl font-bold text-green-600">
                ${(wallet?.total_withdraw_able_balance || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 p-4 space-y-3 bg-gray-50">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">${Number(withdrawAmount || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
                ...
                <div className="flex justify-between pt-2 border-t">
                  ...
                  <span className="font-bold text-green-600">${Number(withdrawAmount || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
              </div>
            </div>
