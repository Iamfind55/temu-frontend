...
export function MegaMenu() {
  ...
  return (
    <div className="absolute left-0 top-full z-50 w-full bg-white shadow-2xl rounded-md border border-green-500">
      <div className="mx-auto flex">
        <div className="w-64 flex-shrink-0 border-r bg-gray-50">
          {categories.map((category) => (
            <button
              ...
              className={`flex w-full items-center justify-between px-4 py-3 text-left text-sm transition-colors ${hoveredCategory.id === category.id
        ...
        <div className="flex-1 p-8 border border-red-500">
